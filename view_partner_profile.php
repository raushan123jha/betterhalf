...
<head>
 ...
 <body>
  <nav class="menu" tabindex="0">
	<button type="submit"> <a href='<?php echo $redirect; ?>'> back </a></button>
  <header class="avatar">
...
<style>#send_proposal_btn{width:295px; height:50px; background:#45b39d;border-radius:5px;margin-left:2px;color: #2e4053;font-size:22px;}</style>
<main>
  <div class="helper">
   <p class="dotted">PERSONAL DETAIL</p>
		...
		"</td></tr><tr><td>DATE OF BIRTH:-</td><td>".$row['dob'].
