...
<html>
	<head>
	<!--css file link for menu and frame -->
	...
	<div id="main_section">
	<?php echo "<img src='img/requested_people.png' id='requested_people'><p id='requested_text'>Requests</p>" ;
	// ############################PHP CODE FOR VIEW REQUEST####################//
	include('respond_request.php'); ?>
	<br><br><br><hr color=" #d7d1d0" size="1px">
<?php 
	$user_from = $_SESSION['email_id'];      //taking email_id of user
		//$user_count = 0;
	$total_request_res = $conn->query("select senderid from request where receiverid='$user_from' and request_status='Pending'");              //query for showing request with pending status
...
?>
  <!--code for showing profile picture,first name and last name,profession,marital status and gender of sender-->
	<table id='table_id'>
