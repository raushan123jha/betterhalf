<?php
     session_start();  
    /*session start here */
     include('connection.php');   /*connection file include for connection to database*/
    //include('send_request.php');
    echo $_SESSION['first_name']." ".$_SESSION['last_name'];       /*for printing the current user first and last name*/
    $_SESSION['aftersearch'] = $_SERVER['REQUEST_URI'];
?>
<html>
	<head>
	    <link href="css/frame.css" rel="stylesheet">                 <!--include the css file here-->
 ...
 <body>
	...
	<div class="topnav" id="myTopnav">
		<a href="user_portal.php" id="home_link">Home</a>        <!--this is for header menus-->
	  ...
	  <script>
	    <!--java script for responsivness of header-->
	    function myFunction() {
	...
	<div id="main_section">
        ...
        <?php 
		  include('search_result_php.php');                    /*include here search result output file*/
        ?>
		 <div>
	<div id="fixedfooter">Copyright@Group6-NITC</div>         <!--it is a footer-->
  </body>
</html>