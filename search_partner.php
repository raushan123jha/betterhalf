<?php 
	require('connection.php'); //including connection and framework file
...
<html>
	...
	<div id="div2">
        <a href="home.html"><img src="img/2.png" height="100" width="80"></a>
			...
			<!--form for set preferences-->
		<form action="search_result.php" method="GET" >
	<div>
		<br>    
		<span class="required">Location: *</span> 
		<input type="text" id="name" name="Location" value="" pattern="[a-zA-Z\s]{2,}" title='Please Enter Alphabets' placeholder="partner's location" required="required" tabindex="1" autofocus="autofocus" />
	...
	<div>
		...
		pattern="[a-zA-Z\s]{2,}" title='Please Enter Alphabets'   tabindex="2" />
	...
	<div>
		...
		<input type="number" id="income" name="income" value="" placeholder="partner's income" tabindex="2" 
	...
	<div>
		...
		pattern="[a-zA-Z\s]{2,}" title='Please Enter Alphabets'/>
		      
	</div>
	<div>
		    
		<span class="required">Age: </span>
		<input type="number" id="age" name="age" value="" placeholder="partner's Age" tabindex="2"
		min="18" max="80"/>
